...
function Project(props) {
  ...
  const imageUrls = [...Array(thisProject.imageNum).keys()].map((i) => `https://raw.githubusercontent.com/ehanover/ehanover.github.io-content/master/${thisProject.github}/img${i + 1}.jpg`);
  const { imageCaptions } = thisProject;
